    ...
    public class PLC
    {
	    ...
	    public ExceptionCode Open()
	    {
		    ...
		    catch  
            {
                ...
                lastErrorString = "IP Adress '" + IP + "' does not exist";
		    ...
		    catch 
            {
                ...
                lastErrorString = "PLC conection was not able to establish";
			    IsConnected = false;
			    return ExceptionCode.ConnectionError;
		    }
        ...
        public object Write(string variable, object value)
        {
            ...
            catch (Exception ex)
            {
                ...
                lastErrorCode = ExceptionCode.WrongVariableFormat;
                lastErrorString = "The variable '" + variable + "' could not be decoded!";
                return lastErrorCode;
            }
        }
        #endregion
        ...
        public ExceptionCode WriteStruct(object structValue, int DB)
        {
            ...
            {
                lastErrorCode = ExceptionCode.WriteData;
                lastErrorString = "Error while writing the data";
                return lastErrorCode;
            }
        }
        #endregion
